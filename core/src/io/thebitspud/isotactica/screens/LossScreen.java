...
public class LossScreen extends JScreenTemplate {
	public LossScreen(Isotactica game) {
		super(game);
	}
	...
	protected void initStageComponents(int width, int height) {
		addTitleLabel("Defeat", width, height);

		addImageButton(1, Align.center, width * 0.5f, height * 0.55f, new JInputListener() {
			@Override
